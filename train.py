...
parser.add_argument('--experiment', default='NoName', type=str, metavar='NAME',
...
def main():
    ...
    output_dir = None
    if args.rank == 0:
        print('Optimizer: ', args.sam_variant)
        # if args.experiment:
        ...
        exp_name = args.experiment + '/'+\
            ...
            args.sam_variant,
            args.note,
            'adaptive' if args.isASAM else '',
            'only_bn' if args.only_bn else ''
        ])
    ...
    try:
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            if model_ema is not None and not args.model_ema_force_cpu:
                ...
                print('Using Ema validation metrics')
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        # if batch_idx==0:
            # print('Rank: {}, Input shape: {}'.format(args.rank, input.size()))
        ...
        paras = [input,target,loss_fct,model,defined_backward,args.sam_variant,args.pickmiddle]
