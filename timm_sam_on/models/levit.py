...
# Modified from
# https://github.com/rwightman/pytorch-image-models/blob/master/timm_esam/models/vision_transformer.py
...
from timm_sam_on.data import IMAGENET_DEFAULT_STD, IMAGENET_DEFAULT_MEAN
